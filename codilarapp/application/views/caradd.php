...
<div id="container">
    ...
    <div class="row clearfix">
        <div class="card">
            ...
            <div class="body">
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/carcompanycontroller/savecar" id="myform">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="companyname" name="companyname" maxlength="30" minlength="3" required="required" aria-required="true" class="form-control" placeholder="Company Name">
                                    </div>
                                </div>
                            </div>
                        </div>
